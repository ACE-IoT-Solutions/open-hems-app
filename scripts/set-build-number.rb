...
app_json = `cat #{app_json_path} | jq --arg versionName "#{version_name}" --argjson versionCode "#{android_version_code}" '.expo.android.versionCode=$versionCode | .expo.version=$versionName | .expo.ios.buildNumber=$versionName'`
